            ...
            <div class="flex-1 overflow-auto pb-60px">
                <div class="flex flex-col h-full">
                    <div class="flex flex-col px-6">
                        ...
                        <div v-if="state.more" class="flex flex-col">
                            <div
                                class="flex justify-between items-center py-4 border-b text-sm font-medium"
                            >
                            ...
                            <div
                                class="flex justify-between items-center py-4 border-b text-sm font-medium"
                            >
                                <span class="text-gray-500">Anguran</span>
                                <span>Rp 100.000 / Bulan</span>
                            </div>
                            <div
                                class="flex justify-between items-center py-4 border-b text-sm font-medium"
                            >
                        ...
                        <div
                            class="p-6 text-13px text-[#F10A13] text-center font-bold cursor-pointer"
                    ...
                    <div
                        class="flex-1 bg-[#F9F9F9] w-full flex flex-col p-6 gap-6"
                    >
                        <div class="font-bold text-16px text-[#404040]">
                            Riwayat Pembayaran
                        </div>
                        <div class="flex flex-col border rounded-2xl bg-white">
                            <div
                                class="px-4 py-4 flex items-center border-b"
                                v-for="i in 10"
                            >
                                <div
                                    class="flex flex-col items-center gap-0.5 pl-2.5 pr-5 border-r h-full py-2"
                                >
                                    <span class="text-23px font-semibold"
                                        >19</span
                                    >
                                    <span
                                        class="text-12px font-medium text-[#8D8D8D]"
                                        >Jun</span
                                    >
                                    <span
                                        class="text-12px font-medium text-[#8D8D8D]"
                                ...
                                <div
                                    class="flex gap-3 items-center w-full pl-4"
                                >
                                    <div
                                        class="flex flex-col gap-2 items-start w-1/3"
                                    >
                                        <span
                                    ...
                                    >
                                        ...
                                        >
                                        <span
                                            class="text-14px font-semibold text-[#EE0C15]"
                                            >200.000</span
                                        >
                                    </div>
                                </div>
