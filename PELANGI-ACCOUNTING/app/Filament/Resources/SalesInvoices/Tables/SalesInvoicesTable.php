            ...
            ->recordActions([
                ActionGroup::make([
                    ...
                    Action::make('printA4')
                        ...
                        ->color('gray')
                        ->url(fn ($record) => SalesInvoiceResource::getUrl('view', ['record' => $record]) . '?print=1&paper=a4')
                        ->openUrlInNewTab(),
                    Action::make('printA5')
                        ->label('Print A5 - Landscape')
                        ->icon('heroicon-o-printer')
                        ->color('gray')
                        ->url(fn ($record) => SalesInvoiceResource::getUrl('view', ['record' => $record]) . '?print=1&paper=a5')
                        ->openUrlInNewTab(),
                    EditAction::make(),
