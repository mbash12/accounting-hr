    ...
    public function processWorkOrder(Request $request): JsonResponse
    {
        ...
        try {
            $validated = $request->validate([
                ...
                'customer.tower'         => ['nullable', 'string', 'max:255'],
                'customer.floor'         => ['nullable', 'string', 'max:255'],
                'customer.lantai'        => ['nullable', 'string', 'max:255'],
                'customer.unit'          => ['nullable', 'string', 'max:255'],
