...
class PurchaseOrderController extends Controller
{
    public function storePurchaseOrder(Request $request)
    {
        ...
        $po = $request->purchase_order_no
            ? \App\Models\PurchaseOrder::where('purchase_order_no', $request->purchase_order_no)->where('company_id', $request->company_id)->first()
            : null;
        ...
        if (!empty($po)) {
            ...
            // If empty, HasAutoGeneratedCode trait will generate via CodeGeneratorService
        }
