...
{
    use HasFactory, SoftDeletes, \App\Traits\EnforcesOpenPeriod;
    ...
    protected static function booted()
    {
        static::deleting(function ($record) {
            ...
            if ($record->cash_bank_transaction_id) {
                CashBankTransaction::find($record->cash_bank_transaction_id)?->delete(); // Use find to avoid error if already deleted or null
            }
        });
    }
