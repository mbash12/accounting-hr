...
class FixedAssetCategoryImport implements ToCollection, WithHeadingRow, WithValidation
{
    ...
    {
        return [
            'name.required' => 'Nama Kategori Aset Tetap wajib diisi.',
            'name.max' => 'Nama Kategori Aset Tetap tidak boleh lebih dari 200 karakter.',
            'code.max' => 'Kode Kategori Aset Tetap tidak boleh lebih dari 50 karakter.',
            'code.unique' => 'Kode Kategori Aset Tetap sudah digunakan.',
            ...
            'sales_account_code.max' => 'Kode Akun Penjualan tidak boleh lebih dari 50 karakter.',
            'sales_account_code.exists' => 'Kode Akun Penjualan tidak ditemukan di perusahaan ini.',
            'asset_account_code.max' => 'Kode Akun Aset tidak boleh lebih dari 50 karakter.',
            'asset_account_code.exists' => 'Kode Akun Aset tidak ditemukan di perusahaan ini.',
            'accumulated_depreciation_account_code.max' => 'Kode Akun Akumulasi Penyusutan tidak boleh lebih dari 50 karakter.',
            'accumulated_depreciation_account_code.exists' => 'Kode Akun Akumulasi Penyusutan tidak ditemukan di perusahaan ini.',
            'depreciation_account_code.max' => 'Kode Akun Penyusutan tidak boleh lebih dari 50 karakter.',
            'depreciation_account_code.exists' => 'Kode Akun Penyusutan tidak ditemukan di perusahaan ini.',
            'sales_account_name.max' => 'Nama Akun Penjualan tidak boleh lebih dari 200 karakter.',
            'asset_account_name.max' => 'Nama Akun Aset tidak boleh lebih dari 200 karakter.',
            'accumulated_depreciation_account_name.max' => 'Nama Akun Akumulasi Penyusutan tidak boleh lebih dari 200 karakter.',
            'depreciation_account_name.max' => 'Nama Akun Penyusutan tidak boleh lebih dari 200 karakter.',
        ];
    }
}