        ...
        <div id="print-area" class="document-page">
            ...
            <div class="header-container">
                <div class="company-branding">
                    ...
                    <div class="company-details">
                        ...
                        <p>
                            ...
                            @if($record->company->billing_address_line_2)<br>{!!
                            nl2br(e($record->company->billing_address_line_2)) !!}@endif
                            @if($record->company->billing_city)<br>{!! nl2br(e($record->company->billing_city)) !!}, {!!
                ...
                <div class="document-info">
                    <h2 class="doc-title">PESANAN PEMBELIAN</h2>
                    <table class="doc-meta-table">
                        <tr>
                            <td class="doc-meta-label">No. Pesanan:</td>
                            <td class="doc-meta-value">{{ $record->purchase_order_no }}</td>
                        </tr>
                        <tr>
            ...
            <div class="address-section">
                <div class="address-box">
                    ...
                    <p>
                        {!! nl2br(e($record->supplier->billing_address_line_1)) !!}
                        @if($record->supplier->billing_address_line_2)<br>{!!
                        nl2br(e($record->supplier->billing_address_line_2)) !!}@endif
                        <br>
                        {!! nl2br(e($record->supplier->billing_city)) !!}
                ...
                <div class="address-box">
                    ...
                    <p><span class="text-muted">Departemen:</span> <strong>{{ $record->department->name }}</strong></p>
                    @endif
            ...
            <div class="items-table-container">
                <table class="items-table">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="text-center" style="padding: 20px;">Tidak ada barang dalam pesanan
                                ini</td>
                        </tr>
                        @endforelse
                    </tbody>
            ...
            <div class="footer-section">
                <div class="notes-area">
                    ...
                    <p class="text-sm text-muted">
                        Ini adalah konfirmasi pesanan pembelian. Tanggal pengiriman bersifat tentatif dan tergantung
                        ketersediaan.
                        <br>
